...
export default function RootLayout(){
  ...
  return <View style={{flex:1}}><StatusBar style="dark"/><Stack screenOptions={{headerShown:false,contentStyle:{backgroundColor:colors.background},animation:"slide_from_right"}}><Stack.Screen name="(tabs)"/><Stack.Screen name="onboarding/welcome" options={{gestureEnabled:false}}/><Stack.Screen name="onboarding/name" options={{gestureEnabled:false}}/><Stack.Screen name="trim"/><Stack.Screen name="processing" options={{gestureEnabled:false}}/><Stack.Screen name="review" options={{gestureEnabled:false}}/><Stack.Screen name="results" options={{gestureEnabled:false}}/><Stack.Screen name="history"/><Stack.Screen name="account"/><Stack.Screen name="paywall" options={{gestureEnabled:false}}/></Stack><AnalyzerEngineHost/><ReviewOverlay/></View>}
